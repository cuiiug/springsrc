...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	 ...
	 */
	/**
	 * 对于解析一个XML，SAX首先读取该XML文档上的声明，根据声明去寻找响应的DTD定义，以便对文档进行验证。
	 * 默认的寻找规则通过网络来下载声明，并进行验证。如果中断会报错
	 * 
	 * EntityResolver的作用就是项目本身就可以提供一个寻找DTD声明的方法，实现寻找DTD声明的过程，避免网络下载。
	 */
	 ...
	 *            the resource descriptor for the XML file, allowing to specify an
	 ...
	 * none is specified. Default implementation returns an instance of
